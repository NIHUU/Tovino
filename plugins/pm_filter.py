...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, DELETE_TIME, P_TTI_SHOW_OFF, IMDB, REDIRECT_TO, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, START_IMAGE_URL, UNAUTHORIZED_CALLBACK_TEXT, redirected_env, CH_LINK
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text=f"Pᴀɢᴇs", callback_data="pages"),
             InlineKeyboardButton(text=f"{round(int(offset) / 10)", callback_data="pages"),
